    ...
    <div class="cauldron-page">
      ...
      <div class="cauldron-container">
          ...
          <div class="cauldron-liquid">
            ...
            <div class="cauldron-content">
              ...
              <div class="current-potion">
                ...
                <button class="brew-button" @click="brewPotion">Brew Potion</button>
              </div>
            </div>
          </div>
        ...
        <div class="fire-effect">
          <div class="flame" v-for="(flame, index) in flames" :key="index" 
               :style="flame.style"></div>
        </div>
      </div>
    </div>
  </template>
  ...
  export default {
    data() {
      return {
        ...
        bubbles: Array(15).fill().map(() => this.createBubble()),
        flames: Array(5).fill().map(() => this.createFlame()),
        bubbleInterval: null,
        flameInterval: null
      }
    },
    ...
    methods: {
      brewPotion() {
        ...
        this.bubbles = Array(30).fill().map(() => this.createBubble(true));
      },
